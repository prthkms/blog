...
As most people, I found myself reaching for my smartphone far too often. Sometimes its a boring work meeting, sometimes it was to fill the idle 2 mins while I wait for the microwave to heat my food. Instead of blocking an app which usually does not last as I might need that app for something credible, I wanted to introduce an additional step, a deterrant. This shortcut blocks app open and throws a prompt where I have to enter "Yes I want to open X", X = instagram or youtube or whatever is your poison. The small delay in gratification, additional effort required to open the app and a little guilt trip is enough to make a big dent in screen time.
